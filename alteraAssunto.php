<?php
    ...
    $stmt = $pdo->prepare('SELECT * FROM "assunto" WHERE codas ='.$cod);
    $stmt->execute();
    $resData=$stmt->fetchAll();

    foreach($resData as $rowData){
        $nome = $rowData['descricao'];
    }        
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <script>
        $(document).ready(function(){
            $('#gravar').click(function() {
                ...
                $.post('gravaAutorAssunto.php', {orig: 1, codigo: codigo, nome: nome}, function(data) {
