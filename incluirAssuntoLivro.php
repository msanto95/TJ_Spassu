...
<body>
    <script>
       $(document).ready(function(){
        ...
        $('#selAss').load('loadElement.php?orig=1&cod='+codLivro);  
             
           $('button#gravar').click(function(){

            var valorSelecionado = $('#selAss').val();

              
              $.post('gravaInfo.php', {orig:3, codigo: codLivro, val: valorSelecionado}, function(data){
    ...
    <div class="container-fluid bg-dark text-light py-3"> 
        <header class="text-left">
           <h5>Livro>>Assunto>>Incluir Assunto</h5>
        </header>
    </div>
  <div class="w-50 p-3">
            ...
            <form class="row g-3">
                <div class="col-12">
                    ...
                    <legend>Assuntos</legend>
                        <select class="form-select" id="selAss">
